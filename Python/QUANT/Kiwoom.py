...
class Kiwoom(QAxWidget):
    ...
    # Open API+ 에서 계좌 정보 및 로그인 사용자 정보를 얻어오기 위해 GetLoginInfo 메서드 호출
...
if __name__ == "__main__":
    ...
    # kiwoom.set_input_value("계좌번호", "8147602611")
    # kiwoom.set_input_value("비밀번호", "5425")
    ...
    #
    # con = sqlite3.connect("E:\\01_Project\\00_GitHub_Repository\\Study\\Python\\QUANT\\stock.db")
